---
name: customize-buddy
description: This skill should be used when the user asks to "customize buddy", "change my buddy", "evolve buddy", "customize-buddy", "I want a different buddy", "change buddy species", "make my buddy shiny", or "modify my terminal pet". Launches an interactive evolution ceremony.
argument-hint: "[species]"
---

# Customize Buddy — Evolution Ceremony
...
If the user provided a species argument (`$ARGUMENTS`), use it and skip to rarity selection.
...
To revert anytime: /restore-buddy
```
...
- Suggest running `/restore-buddy` to revert
- Note that binary offsets are version-specific — if Claude Code just updated, the script may need updating
