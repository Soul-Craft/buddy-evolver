...
run_tier "integration" "End-to-end patch/restore/metadata flows" \
    bash "$SCRIPT_DIR/test-integration.sh"

run_tier "functional" "Byte-level patch correctness + Mach-O validity" \
    bash "$SCRIPT_DIR/test-functional.sh"
